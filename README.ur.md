...
- 🔔 **ہر نماز سے 5 منٹ پہلے** اور پھر وقت آنے پر نوٹیفکیشن بھیجتی ہے (Fajr, Dhuhr, Asr, Maghrib, Isha) — آپ کی منتخب کردہ زبان میں۔
- 🔒 **اختیاری ٹیب لاک** — جب نماز کا وقت آئے تو ایک قابلِ ترتیب مدت (1–120 منٹ، ڈیفالٹ 5) کے لیے فعال براؤزر ٹیب کو بلاک کرتی ہے، ساتھ ہی کاؤنٹ ڈاؤن اوورلے بھی ہوتا ہے؛ کلوز بٹن کے ذریعے دستی ان لاک کا آپشن۔
...
- 📅 **Gregorian date format** — فوٹر کی تاریخ کس طرح دکھانی ہے منتخب کریں (مثلاً `10-04-2026`, `10 April 2026`, طویل متن)۔
...
| Date format | فوٹر میں Gregorian تاریخ کس طرح دکھے گی۔ |
| Number style | جب Arabic یا Urdu فعال ہو: Arabic-Indic (٠١٢٣) یا Western (0123) اعداد اوقات اور کاؤنٹ ڈاؤن کے لیے۔ |
| Lock tab during prayer | نماز کے وقت فعال ٹیب پر مکمل صفحہ اوورلے ڈالتی ہے۔ |
...
| `background.js` | سروس ورکر — اوقات لاتا ہے، `chrome.alarms` شیڈول کرتا ہے، لوکلائز نوٹیفکیشن دکھاتا ہے، اور نماز کے وقت فعال ٹیب لاک کرتا ہے۔ |
...
| `tasbih-phrases.js` | 100 منفرد dhikr فقرے (Arabic + English transliteration)۔ |
...
- **Scheduling:** انسٹال/اسٹارٹ اپ پر اور جب بھی لوکیشن تبدیل ہو، service worker آج کے timings لاتا ہے اور ہر آنے والی نماز سے 5 منٹ پہلے اور خود نماز کے وقت پر `chrome.alarms` کے ایک شاٹ اندراجات بناتا ہے، ساتھ ہی آدھی رات کے فوراً بعد refresh alarm بھی۔
- **Tab lock:** اگر settings میں فعال ہو تو، جب نماز کا الارم بجتا ہے تو ایکسٹینشن فعال ٹیب میں `content-lock.js` inject کرتی ہے اور مقررہ مدت کے لیے کاؤنٹ ڈاؤن اوورلے دکھاتی ہے۔ یہ اوورلے صفحے پر کی بورڈ، اسکرول اور pointer input کو بلاک کرتا ہے۔ **Allow manual unlock** کو فعال کریں تاکہ (×) کلوز بٹن دکھے۔ موجودہ ٹیب پر پیش نظارہ کے لیے settings میں **Test tab lock** استعمال کریں۔
...
- **Notifications:** جب ریمائنڈر یا نماز کا الارم چلتا ہے تو سسٹم نوٹیفکیشن ظاہر ہوتا ہے (`requireInteraction` تاکہ ڈسمس ہونے تک برقرار رہے)۔
