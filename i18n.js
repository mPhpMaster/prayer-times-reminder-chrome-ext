...
const I18N = {
  en: {
    ...
    notifSoonTitle: (p) => `${p} in 5 minutes`,
    notifSoonBody: (p) => `Prayer time is in 5 minutes. Prepare for ${p}.`,
  ...
  ar: {
    ...
    notifSoonTitle: (p) => `صلاة ${p} بعد 5 دقائق`,
    notifSoonBody: (p) => `بقي 5 دقائق على وقت صلاة ${p}. استعد للصلاة.`,
  ...
  ur: {
    ...
    notifSoonTitle: (p) => `${p} 5 منٹ میں`,
    notifSoonBody: (p) => `نماز کا وقت 5 منٹ میں ہے۔ ${p} کے لیے تیار ہوں۔`,
  ...
  fr: {
    ...
    notifSoonTitle: (p) => `${p} dans 5 minutes`,
    notifSoonBody: (p) => `L'heure de la prière est dans 5 minutes. Préparez-vous pour ${p}.`,
  ...
  es: {
    ...
    notifSoonTitle: (p) => `${p} en 5 minutos`,
    notifSoonBody: (p) => `La hora de la oración es en 5 minutos. Prepárate para ${p}.`,
    ...
    prayers: {
      ...
      Asr: "Asr", Maghrib: "Magrib", Isha: "Isha"
    }
  },
  hi: {
    dir: "ltr",
    ...
    notifSoonTitle: (p) => `${p} 5 मिनट में`,
    notifSoonBody: (p) => `नमाज़ का समय 5 मिनट में है। ${p} के लिए तैयार हों।`,
  ...
  id: {
    ...
    notifSoonTitle: (p) => `${p} dalam 5 menit`,
    notifSoonBody: (p) => `Waktu shalat dalam 5 menit. Bersiaplah untuk ${p}.`,
  ...
  de: {
    ...
    notifSoonTitle: (p) => `${p} in 5 Minuten`,
    notifSoonBody: (p) => `Gebetszeit in 5 Minuten. Bereiten Sie sich auf ${p} vor.`,
...
function formatTasbihDisplay(item, lang) {
  ...
  switch (code) {
    case "ar":
      return { lines: [{ text: item.ar, dir: "rtl", variant: "arabic" }] };
    case "ur":
      return { lines: [{ text: item.ur || item.ar, dir: "rtl", variant: "urdu" }] };
    case "fr":
      return {
        lines: [
          { text: item.ar, dir: "rtl", variant: "arabic" },
          { text: item.fr || item.en, dir: "ltr", variant: "translation" }
        ]
      };
    case "es":
      return {
        lines: [
          { text: item.ar, dir: "rtl", variant: "arabic" },
          { text: item.es || item.en, dir: "ltr", variant: "translation" }
        ]
      };
    case "hi":
      return {
        lines: [
          { text: item.ar, dir: "rtl", variant: "arabic" },
          { text: item.hi || item.en, dir: "ltr", variant: "translation" }
        ]
      };
    case "id":
      return {
        lines: [
          { text: item.ar, dir: "rtl", variant: "arabic" },
          { text: item.id || item.en, dir: "ltr", variant: "translation" }
        ]
      };
    case "de":
      return {
        lines: [
          { text: item.ar, dir: "rtl", variant: "arabic" },
          { text: item.de || item.en, dir: "ltr", variant: "translation" }
        ]
      };
    default:
      return { lines: [{ text: item.en, dir: "ltr", variant: "transliteration" }] };
  }
}
...
const TASBIH_POSITIONS = [
  { key: "top-left", en: "Top left", ar: "أعلى اليسار", ur: "اوپر بائیں", hi: "ऊपर बाएँ", id: "Kiri atas", de: "Oben links", fr: "En haut à gauche", es: "Arriba a la izquierda" },
  { key: "top-right", en: "Top right", ar: "أعلى اليمين", ur: "اوپر دائیں", hi: "ऊपर दाएँ", id: "Kanan atas", de: "Oben rechts", fr: "En haut à droite", es: "Arriba a la derecha" },
  { key: "top-center", en: "Top center", ar: "أعلى الوسط", ur: "اوپر درمیان", hi: "ऊपर केंद्र", id: "Tengah atas", de: "Oben mittig", fr: "En haut au centre", es: "Arriba al centro" },
  { key: "bottom-left", en: "Bottom left", ar: "أسفل اليسار", ur: "نیچے بائیں", hi: "नीचे बाएँ", id: "Kiri bawah", de: "Unten links", fr: "En bas à gauche", es: "Abajo a la izquierda" },
  { key: "bottom-right", en: "Bottom right", ar: "أسفل اليمين", ur: "نیچے دائیں", hi: "नीचे दाएँ", id: "Kanan bawah", de: "Unten rechts", fr: "En bas à droite", es: "Abajo a la derecha" },
  { key: "bottom-center", en: "Bottom center", ar: "أسفل الوسط", ur: "نیچے درمیان", hi: "नीचे केंद्र", id: "Tengah bawah", de: "Unten mittig", fr: "En bas au centre", es: "Abajo al centro" }
];
...
// Gregorian footer date format presets (id matches the pattern name).
const DATE_FORMATS = [
  { id: "dd-mmMMMM-yyyy", en: "10-04 April-2026", ar: "١٠-٠٤ أبريل-٢٠٢٦" },
  { id: "dd-mm-yyyy", en: "10-04-2026", ar: "١٠-٠٤-٢٠٢٦" },
  { id: "dd/MM/yyyy", en: "10/04/2026", ar: "١٠/٠٤/٢٠٢٦" },
  { id: "dd-MMMM-yyyy", en: "10 April 2026", ar: "١٠ أبريل ٢٠٢٦" },
  { id: "MMMM-dd-yyyy", en: "April-10-2026", ar: "أبريل-١٠-٢٠٢٦" },
  { id: "readable", en: "Long text (API default)", ar: "نص طويل (افتراضي)" }
];
...
const DEFAULT_CITY_LABELS = {
  "cityLabels:Saudi Arabia": { Riyadh: "الرياض" }
};
